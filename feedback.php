               ...
               <div class="col-lg-8 offset-lg-2">
                  <div class="full">
                     <form action="controller/records.php" method="post">
                        <fieldset>
                           <input type="hidden" value="<?php echo $uid ; ?>" placeholder="Enter your full name" name="uid" required />
                           <!-- <input type="email" placeholder="Enter your email address" name="email" required /> -->
                           <input type="text" placeholder="Enter subject" name="subject" required />
                           <textarea placeholder="Enter your message" name="desc" required></textarea>
